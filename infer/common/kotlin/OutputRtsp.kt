...
object OutputRtsp : suspend (String, String, String, Flow<Frame>) -> Unit {
    data class Context(val formatCtx: CPointer<AVFormatContext>, val stream: AVStream) : AutoCloseable {
    ...
    override suspend fun invoke(original: String, processed: String, id: String, inputFlow: Flow<Frame>) {
